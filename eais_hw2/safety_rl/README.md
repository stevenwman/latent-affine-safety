...
RARL is primarily developed by Kai-Chieh Hsu, a PhD student in the [Safe Robotics Lab](https://saferobotics.princeton.edu), and Vicenç Rubies-Royo, a postdoc in the [Hybrid Systems Lab](http://hybrid.eecs.berkeley.edu). You can see the spotlight talk [here](https://www.youtube.com/watch?v=8v7yW5twGOk).


The repository also serves as the companion code to our [RSS 2021 paper](https://arxiv.org/abs/2112.12288), where you can find the theoretical properties of the proposed algorithm as well as the implementation details.
...
However, it can be used in conjunction with an existing safe learning scheme, such as "shielding", to enable learning with safety guarantees (see Script 4 below as well as Section IV.B in the [RSS 2021 paper](https://arxiv.org/abs/2112.12288) for an example).
...
## II. Replicating the results in the [RSS 2021 paper](https://arxiv.org/abs/2112.12288)
...
## Paper Citation
If you use this code or find it helpful, please consider citing the companion [RSS 2021 paper](https://arxiv.org/abs/2112.12288) as:
```
