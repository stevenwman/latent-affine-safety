...
register(
    id="dubins_car_avoid-v1",
    entry_point="gym_reachability.gym_reachability.envs:DubinsCarAvoidEnv"
)

register(
    id="dubins_car_latent_avoid-v1",
    entry_point="gym_reachability.gym_reachability.envs:DubinsCarAvoidLatentEnv"
)
