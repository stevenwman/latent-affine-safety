...
if __name__ == "__main__":
    ...
    # car dynamics
    parser.add_argument("-cr", "--consRadius", help="constraint radius", default=0.5, type=float)
    parser.add_argument("-turn", "--turnRate", help="turning rate", default=1.25, type=float)
    parser.add_argument("--dt", help="timestep", default=0.05, type=float)
    ...
    parser.add_argument("-cp", "--checkPeriod", help="check period", default=10000, type=int)
    ...
    parser.add_argument("-of", "--outFolder", help="output file", default='experiments', type=str)
